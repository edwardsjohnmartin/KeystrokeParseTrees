...
public class App {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        System.out.println(loader.getResource("parser/App.class"));
        System.out.println(loader.getResource("log4j.properties"));
//        PropertyConfigurator.configure("log4j.properties");
//        System.out.println(ResourceBundle.getBundle("main"));
//        InputStream is = App.getClassLoader().getResourceAsStream("log4j.properties");
...
//        String key = "Student1_Assign12_task2.py";
//        String[] keys = {"Student1_Assign12_task2.py",
//                "Student1_Assign12_task1.py",
////                "Student12_Assign6_task1.py",
//                "Student28_Assign13_wordinator.py",
//                "Student10_Assign10_Chessboard.py"};
...
//          System.out.println(selection.first(10));
            ...
            try {
                ...
                System.out.println("Failed to reconstruct " + key);
            }
        }
        final long endTime = System.currentTimeMillis();
        System.out.println("reconstruction time: " + (endTime-startTime)/1000.0);

//        logger.info("Constructed " + reconstruction.numSnapshots + " snapshots");
//        System.out.println("sout " + logger.getName());
//        logger.info("info " + logger.getName());
//        logger.debug("debug " + logger.getName());
//
////        int start = 0, len = 3;
...
//
//        origTrees.outputGraphViz("output/orig.dot");
//        Trees prunedTrees = origTrees.prune();
//        prunedTrees.outputGraphViz("output/pruned.dot");
//        Trees reconTrees = prunedTrees.reconstructFromPruned();
//        reconTrees.outputGraphViz("output/recon.dot");
...
//            fn = "src/main/resources/sample2.csv";
